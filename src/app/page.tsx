...
import type { ErosionReport, LocationMarker } from '@/lib/types';
import {
  Sidebar,
  SidebarContent,
  SidebarHeader,
...
const Home: FC = () => {
  const [locations] = useState<LocationMarker[]>(initialLocations);
  const [analysisResult, setAnalysisResult] = useState<ErosionReport | null>(null);
