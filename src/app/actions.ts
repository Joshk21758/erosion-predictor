...
import { generateErosionSummary, type GenerateErosionSummaryInput, type GenerateErosionSummaryOutput } from '@/ai/flows/generate-erosion-summary';
import { z } from 'zod';
...
type ActionResult = {
    data: GenerateErosionSummaryOutput | null;
    error: string | null;
}

export async function getErosionSummary(values: GenerateErosionSummaryInput): Promise<ActionResult> {
