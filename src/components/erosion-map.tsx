...
import type { LocationMarker, RiskLevel } from '@/lib/types';
...
interface ErosionMapProps {
  ...
  onSelectLocation: (location: LocationMarker | null) => void;
}
...
export const ErosionMap: FC<ErosionMapProps> = ({ locations, selectedLocation, onSelectLocation }) => {
  return (
