...
import type { ErosionReport, RiskLevel } from '@/lib/types';
...
const riskLevelStyles: Record<RiskLevel, { icon: React.ReactNode; color: string; }> = {
  Low: {
...
export const RiskReport: FC<RiskReportProps> = ({ report }) => {
