...
export type GenerateErosionSummaryInput = z.infer<typeof GenerateErosionSummaryInputSchema>;
...
export type GenerateErosionSummaryOutput = z.infer<typeof GenerateErosionSummaryOutputSchema>;

export async function generateErosionSummary(input: GenerateErosionSummaryInput): Promise<GenerateErosionSummaryOutput> {
